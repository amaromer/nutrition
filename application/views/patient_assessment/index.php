<div id="page-content" class="p20 clearfix">
    <div class="panel panel-default">
        <div class="page-title clearfix">
            <h1><?php echo lang('patient_assessment'); ?></h1>
            <div class="title-button-group">
                <div class="btn-group" role="group">
                    ...
                    <?php //echo anchor(get_uri("patient_assessment/view"), "<i class='fa fa-th-large'></i>", array("class" => "btn btn-default btn-sm")); ?>
                </div>
                <?php
                if ($this->login_user->is_admin) {
                    // echo modal_anchor(get_uri("patient_assessment/invitation_modal"), "<i class='fa fa-envelope-o'></i> " . lang('send_invitation'), array("class" => "btn btn-default", "title" => lang('send_invitation')));
                    echo modal_anchor(get_uri("patient_assessment/modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_patient_assessment'), array("class" => "btn btn-default", "title" => lang('add_patient_assessment')));
                }
                ?>
            </div>
        </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#team_member-table").appTable({
            source: '<?php echo_uri("patient_assessment/list_data/") ?>',
            order: [[1, "asc"]],
