            ...
            <div class="tab-title clearfix">
                ...
                <div class="title-button-group">
                    ...
                    if ($this->login_user->user_type == "staff" || ($this->login_user->user_type == "client" && get_setting("client_can_add_files"))) {
                        echo modal_anchor(get_uri("clients/file_modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_files'), array("class" => "btn btn-default", "title" => lang('add_files'), "data-post-client_id" => $patient_id));
                    }
                    ?>
                </div>
            </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#client-file-table").appTable({
            source: '<?php echo_uri("clients/files_list_data/" . $patient_id) ?>',
            order: [[0, "desc"]],
            columns: [
