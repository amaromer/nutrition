<?php echo form_open(get_uri("patients/save_file"), array("id" => "file-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix">
    <input type="hidden" name="patient_id" value="<?php echo $patient_id; ?>" />
    <?php
    $this->load->view("includes/multi_file_uploader", array(
        "upload_url" => get_uri("patients/upload_file"),
        "validation_url" => get_uri("patients/validate_file"),
    ));
    ?>
</div>
