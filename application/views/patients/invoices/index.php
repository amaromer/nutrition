            ...
            <div class="tab-title clearfix">
                ...
                <div class="title-button-group">
                    ...
                    if ($can_edit_invoices) {
                        echo modal_anchor(get_uri("invoices/modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_invoice'), array("class" => "btn btn-default mb0", "data-post-client_id" => $patient_id, "title" => lang('add_invoice')));
                    }
                    ?>
                </div>
            </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        var currencySymbol = "<?php echo $patient_info->currency_symbol; ?>";
        $("#invoice-table").appTable({
            source: '<?php echo_uri("invoices/invoice_list_data_of_client/" . $patient_id) ?>',
            order: [[0, "desc"]],
