...
<div class="form-group">
    <label for="company_name" class="<?php echo $label_column; ?>"><?php echo lang('patient_name'); ?></label>
...
<?php if ($this->login_user->user_type === "staff") { ?>
    <div class="form-group">
        <label for="groups" class="<?php echo $label_column; ?>"><?php echo lang('patient_groups'); ?></label>
        <div class="<?php echo $field_column; ?>">
            <?php
            echo form_input(array(
                "id" => "group_ids",
                ...
                "class" => "form-control",
                "placeholder" => lang('patient_groups')
            ));
            ?>
        </div>
    </div>
