 ...
 * @return html link
 */
if (!function_exists('get_patient_contact_profile_link')) {

    function get_patient_contact_profile_link($id = 0, $name = "", $attributes = array()) {
        return anchor("patients/patient_profile/" . $id, $name, $attributes);
    }
