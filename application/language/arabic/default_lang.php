...
/* messages */
$lang["error_occurred"]="عذرا ، حدث خطأ أثناء معالجة الإجراء! <br /> يرجى المحاولة مرة أخرى في وقت لاحق." ;
$lang["field_required"]= "هذه الخانة مطلوبه.";
$lang["end_date_must_be_equal_or_greater_than_start_date"]= "يجب أن يكون تاريخ الانتهاء مساويًا لتاريخ البدء أو أكبر منه." ;
$lang["date_must_be_equal_or_greater_than_today"]= "يجب أن يكون التاريخ مساويًا لليوم أو أكبر منه." ;
$lang["enter_valid_email"]= "يرجى إدخال عنوان بريد إلكتروني صالح.";
...
$lang["something_went_wrong"]= "تبا شيء ما حدث بشكل خاطئ!";
...
$lang["max_file_size_3mb_message"]= "يجب ألا يزيد حجم الملف عن 3 ميغا بايت" ;
$lang["keep_it_blank_to_use_default"]= "اتركه فارغًا لاستخدام الافتراضي" ;
$lang["admin_user_has_all_power"]= "المستخدم الإداري لديه القدرة على الوصول / تعديل كل شيء في هذا النظام!" ;
$lang["no_posts_to_show"]= "لا توجد مشاركات لعرضها" ;


/* team_member */
$lang["add_team_member"]="إضافة عضو";
$lang["edit_team_member"]= "تحرير عضو الفريق" ;
...
$lang["mailing_address"]= "عنوان المراسلة";
...
$lang["reset_info_send"]= "تم إرسال البريد الإلكتروني! <br /> يرجى التحقق من بريدك الإلكتروني للحصول على الإرشادات." ;
...
$lang["invite_someone_to_join_as_a_team_member"]= "دعوة شخص ما للانضمام كعضو في الفريق." ;
...
/* events */
$lang["add_event"]="إضافة موعد" ;
$lang["edit_event"]= "تحرير الموعد" ;
$lang["delete_event"]= "حذف الموعد" ;
$lang["events"]= "المواعيد" ;
$lang["event_calendar"]= "تقويم الموعد";
$lang["location"]= "موقع";
$lang["event_details"]= "تفاصيل الموعد";
$lang["event_deleted"]= "الموعد تم الغائه.";
$lang["view_on_calendar"]= "عرض في التقويم" ;
$lang["no_event_found"]= "لم يتم العثور على أي موعد!" ;
$lang["events_today"]= "مواعيد اليوم" ;
